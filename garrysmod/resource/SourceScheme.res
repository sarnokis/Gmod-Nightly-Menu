...
Scheme
{
	...
	Colors
	{
		...
		"AchievementsLightGrey"		"88 114 70 255"
		"AchievementsDarkGrey"		"153 50 204 255"
	...
	BaseSettings
	{
		// vgui_controls color specifications // CONSOLE
		...
		Button.BgColor					"65 2 166 255"
		Button.ArmedTextColor			"255 255 255 255"
		Button.ArmedBgColor				"93 118 203 255"	[$WIN32]
		Button.ArmedBgColor				"0 0 139 255"		[$X360]
		Button.DepressedTextColor		"White"
		Button.DepressedBgColor			"100 149 237 255"
		...
		Frame.OutOfFocusBgColor			"GMod_BG_Opaque"	[$WIN32]
		Frame.OutOfFocusBgColor			"GMod_BG_Opaque"		[$X360]
		...
		ListPanel.BgColor					"24 7 51 250"
		ListPanel.SelectedTextColor			"White"
		ListPanel.SelectedBgColor			"25 25 112 204"
		ListPanel.OutOfFocusSelectedTextColor	"White"
		ListPanel.SelectedOutOfFocusBgColor		"62 95 138 100"
		ListPanel.EmptyListInfoTextColor	"White"

		Menu.TextColor					"255 255 255 255"
		Menu.BgColor					"43 0 112 240"
		Menu.ArmedTextColor				"White"
		Menu.ArmedBgColor				"62 95 131 255"
		Menu.TextInset					"6"
		...
		RichText.SelectedBgColor		"59 89 152 204"

		ScrollBar.Wide					15

		ScrollBarButton.FgColor				"60 60 60 255"
		ScrollBarButton.BgColor				"207 207 207 255"
		ScrollBarButton.ArmedFgColor		"71 67 137 255"
		ScrollBarButton.ArmedBgColor		"210 237 255 255"
		ScrollBarButton.DepressedFgColor	"71 67 137 255"
		ScrollBarButton.DepressedBgColor	"154 206 235 255"

		ScrollBarSlider.FgColor				"18 10 143 229"			// nob color
		ScrollBarSlider.BgColor				"60 5 150 229"	// slider background color
		...
		SectionedListPanel.BgColor			"24 7 51 250"
		SectionedListPanel.SelectedTextColor			"White"
		SectionedListPanel.SelectedBgColor				"93 118 203 204"
		SectionedListPanel.OutOfFocusSelectedTextColor	"White"
		SectionedListPanel.OutOfFocusSelectedBgColor	"59 89 152 100"
		...
		TextEntry.SelectedBgColor	"93 118 203 255"
